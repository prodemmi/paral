...
func (v *Variable) AsList() (*ListValue, bool) {
...
func (v *Variable) AsInt() (*IntValue, bool) {
...
func (v *Variable) AsFloat() (*FloatValue, bool) {
...
func (v *Variable) AsString() (*StringValue, bool) {
...
func (v *Variable) AsBool() (*BoolValue, bool) {
...
func (v *Variable) AsDuration() (*DurationValue, bool) {
...
func (v *Variable) GetMatrixCombinations() ([][]interface{}, error) {
	mv, ok := v.AsMatrix()
	if !ok {
...
func (v *Variable) Format() (typeStr string, valueStr string) {
